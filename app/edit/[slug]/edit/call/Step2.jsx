...
const Step2 = ({
  ...
  const [title, setTitle] = useState("Contact Methods");
  ...
  const setTextHandler = (e, id) => {
    ...
    const filtered = selectedMessengerCopy.find((f) => f.id === id);
    filtered.text = e.target.value;
