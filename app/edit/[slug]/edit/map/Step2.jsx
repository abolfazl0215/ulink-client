...
const Step2 = ({
  ...
  const handleSubmit = async () => {
    const filteredData = selectedMessenger.filter((f) => !f.link);
    if (filteredData[0]) {
        ...
        {selectedMessenger.map((d, index) => (
          <div
            ...
            <div
              ...
              <div>
                <div
                  className={!d.link && isSubmit ? styles.redBgc : ""}
            ...
            {showSelectSection && showSelectSection[d.id] ? (
              <div className={styles.formBlockBody}>
                <label>Link for {d.enName || d.faName}</label>
                <input
                  type="url"
                ...
                <p>Enter your {d.enName || d.faName} link</p>
              </div>
            ) : (
              ""
            )}
