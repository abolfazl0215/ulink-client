...
const Step2 = ({
  ...
  const [title, setTitle] = useState("Frequentlly questions");
  ...
  const setQuestionHandler = (e, id) => {
    ...
    filteredselectedMessenger[0].question = e.target.value;
    setSelectedMessenger(selectedMessengerCopy);
  };
  const setAnswerHandler = (e, id) => {
    // const dataCopy = [...data];
    // const filteredData = dataCopy.filter((f) => f._id === id);
    ...
    filteredselectedMessenger[0].answer = e.target.value;
    setSelectedMessenger(selectedMessengerCopy);
  };
          ...
          <div
            ...
            {showSelectSection && showSelectSection[d._id] ? (
              <div className={styles.formBlockBody}>
                ...
                <input
                  type="text"
                  onChange={(e) => setQuestionHandler(e, d._id)}
                  value={d.question}
                />
                {!d.question && isSubmit ? (
                ...
                <input
                  type="url"
                  onChange={(e) => setAnswerHandler(e, d._id)}
                  value={d.answer}
                />
                {!d.answer && isSubmit ? (
                  <span className={styles.errorText}>
