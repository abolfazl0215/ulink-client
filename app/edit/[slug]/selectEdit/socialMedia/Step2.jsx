...
const Step2 = ({
  ...
  const handleDeleteBlock = async () => {
    try {
      ...
      handleClose();
      setUpdate((prev) => prev + 1);
      toast.success("The selected section has been deleted");
      setSection("");
    } catch (error) {
      console.log(error);
    }
              ...
              <div className={styles.formBlockBody}>
                ...
                {!d.text && isSubmit ? (
                  <span className={styles.errorText}>
                    Please write a title for this item
                  </span>
                ) : (
                  ""
                )}
                <p>Select a title for this item.</p>
                ...
                <p>
                  Enter your full {d.faName} link. Make sure it is a
                  complete link, not just an ID, phone number, etc.
                </p>
              </div>
            ) : (
              ""
